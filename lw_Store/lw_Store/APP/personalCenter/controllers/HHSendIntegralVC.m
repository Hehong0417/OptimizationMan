...
- (void)viewDidLoad {
    ...
    [_send_Id_textField lh_setCornerRadius:4 borderWidth:1 borderColor:KTitleLabelColor];
    ...
    [_send_integral_textfield lh_setCornerRadius:4 borderWidth:1 borderColor:KTitleLabelColor];
