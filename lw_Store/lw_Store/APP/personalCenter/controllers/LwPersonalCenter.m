...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
      ...
      //活动中心
        ...
        //我的评价
        HHMyEvaluationListVC *vc = [HHMyEvaluationListVC new];
        [self.navigationController pushVC:vc];
        ...
        if ([self.isJoinAgent isEqual:@1]) {
            ...
            if (self.mineModel.ReferralUserName) {
                ...
                if ([self.isExtraBonus isEqual:@1]) {
                    return @[@[@"分享赚钱",@"",@"您是由【德玛西亚】推荐的"],@[@"地址管理"],@[@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心",@"额外奖励"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }else{
                    return @[@[@"分享赚钱",@"",@"您是由【德玛西亚】推荐的"],@[@"地址管理"],@[@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }
                
            }else{
                if ([self.isExtraBonus isEqual:@1]) {
                    return @[@[@"分享赚钱",@""],@[@"地址管理"],@[@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心",@"额外奖励"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }else{
                    return @[@[@"分享赚钱",@""],@[@"地址管理"],@[@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }
            }
            ...
            if (self.mineModel.ReferralUserName) {
                ...
                if ([self.isExtraBonus isEqual:@1]) {
                    return @[@[@"分享赚钱",@"",@"您是由【德玛西亚】推荐的"],@[@"地址管理"],@[@"申请代理",@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心",@"额外奖励"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }else{
                    return @[@[@"分享赚钱",@"",@"您是由【德玛西亚】推荐的"],@[@"地址管理"],@[@"申请代理",@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }
                
            }else{
                if ([self.isExtraBonus isEqual:@1]) {
                    
                    return @[@[@"分享赚钱",@""],@[@"地址管理"],@[@"申请代理",@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心",@"额外奖励"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }else{
                    return @[@[@"分享赚钱",@""],@[@"地址管理"],@[@"申请代理",@"我的积分",@"会员等级"],@[@"我的活动",@"活动中心"],@[@"我的收藏",@"我的优惠券",@"我的评价"],@[@"设置"]];
                }
            }
