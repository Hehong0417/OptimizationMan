...
- (void)setCellWithUsableComm:(NSString *)usableComm fanscount:(NSString *)fanscount saletotal:(NSString *)saletotal{
    ...
    self.section1  = [HHPersonCenterView personViewWithFrame:CGRectMake(0, 0, ScreenW/3, WidthScaleSize_H(70)) btn_imageName:@"wallet" btn_titleName:@"奖励" lab_titleName:[NSString stringWithFormat:@"%@元",usableComm?usableComm:@"0"]];
    ...
    self.section2  = [HHPersonCenterView personViewWithFrame:CGRectMake(ScreenW/3+1, 0, ScreenW/3, WidthScaleSize_H(70)) btn_imageName:@"fans" btn_titleName:@"粉丝" lab_titleName:[NSString stringWithFormat:@"%@人",fanscount?fanscount:@"0"]];
    ...
    self.section3  = [HHPersonCenterView personViewWithFrame:CGRectMake(ScreenW*2/3+1, 0, ScreenW/3-1, WidthScaleSize_H(70)) btn_imageName:@"sales" btn_titleName:@"销售额" lab_titleName:[NSString stringWithFormat:@"%@元",saletotal?saletotal:@"0"]];
