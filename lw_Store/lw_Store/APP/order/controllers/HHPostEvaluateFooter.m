...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        //订单评价
        UILabel *order_evaluate_lab = [UILabel lh_labelWithFrame:CGRectMake(CGRectGetMaxX(order_evaluate_ico.frame), 0, AdapationLabelHeight(80), AdapationLabelHeight(45)) text:@"订单评价" textColor:kBlackColor font:FONT(15) textAlignment:NSTextAlignmentCenter backgroundColor:kWhiteColor];
        ...
        //描述相符
        UILabel *left_discrib_lab = [UILabel lh_labelWithFrame:CGRectMake(15, CGRectGetMaxY(grageView.frame), AdapationLabelHeight(80), AdapationLabelHeight(45)) text:@"物流服务" textColor:kGrayColor font:FONT(14) textAlignment:NSTextAlignmentCenter backgroundColor:kWhiteColor];
        [self addSubview:left_discrib_lab];
        
        //CDPStarEvaluation星形评价
        self.starEvaluation=[[CDPStarEvaluation alloc] initWithFrame:CGRectMake(CGRectGetMaxX(left_discrib_lab.frame),CGRectGetMaxY(grageView.frame),ScreenW-AdapationLabelHeight(80),AdapationLabelHeight(45)) onTheView:self];
        self.starEvaluation.delegate=self;
        
        //        self.discrib_lab = [UILabel lh_labelWithFrame:CGRectMake(CGRectGetMaxX(left_discrib_lab.frame)+AdapationLabelHeight(160), 0, AdapationLabelHeight(80), AdapationLabelHeight(45)) text:@"" textColor:kGrayColor font:FONT(14) textAlignment:NSTextAlignmentCenter backgroundColor:kWhiteColor];
        //        [self.contentView addSubview:self.discrib_lab];
        
        //物流服务
        UILabel *left_logistics_lab = [UILabel lh_labelWithFrame:CGRectMake(15, CGRectGetMaxY(left_discrib_lab.frame), AdapationLabelHeight(80), AdapationLabelHeight(45)) text:@"服务态度" textColor:kGrayColor font:FONT(14) textAlignment:NSTextAlignmentCenter backgroundColor:kWhiteColor];
        [self addSubview:left_logistics_lab];
        
        //        self.logistics_lab = [UILabel lh_labelWithFrame:CGRectMake(self.discrib_lab.frame.origin.x, CGRectGetMaxY(self.discrib_lab.frame), AdapationLabelHeight(80), AdapationLabelHeight(45)) text:@"" textColor:kGrayColor font:FONT(14) textAlignment:NSTextAlignmentCenter backgroundColor:kWhiteColor];
        //        [self.contentView addSubview:self.logistics_lab];
        
        //CDPStarEvaluation
        self.starEvaluation2=[[CDPStarEvaluation alloc] initWithFrame:CGRectMake(CGRectGetMaxX(left_logistics_lab.frame),CGRectGetMaxY(left_discrib_lab.frame),ScreenW-AdapationLabelHeight(80),AdapationLabelHeight(45)) onTheView:self];
        self.starEvaluation2.delegate= self;
        
        UIButton *addAddressBtn = [UIButton lh_buttonWithFrame:CGRectMake(60, CGRectGetMaxY(left_logistics_lab.frame)+20, SCREEN_WIDTH-120, AdapationLabelHeight(35)) target:self action:@selector(pushEvulation:) image:nil];
