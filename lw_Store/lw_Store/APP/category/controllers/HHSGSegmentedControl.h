...
@protocol HHSGSegmentedControlDelegate <NSObject>
// delegate 方法
...
@interface HHSGSegmentedControl : UIScrollView
...
@property (nonatomic, weak) id<HHSGSegmentedControlDelegate> delegate_SG;
